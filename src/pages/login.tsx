  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-constellation" aria-hidden="true">
        <span className="auth-emoji" style={{ top: '10%', left: '15%' }}>✧</span>
        <span className="auth-emoji" style={{ top: '80%', right: '10%' }}>✦</span>
        <span className="auth-emoji" style={{ bottom: '15%', left: '25%' }}>⋆</span>
        <span className="auth-emoji" style={{ top: '20%', right: '30%' }}>☾</span>
      </div>
