  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-constellation" aria-hidden="true">
        <span className="auth-emoji" style={{ top: '15%', right: '20%' }}>✧</span>
        <span className="auth-emoji" style={{ bottom: '20%', left: '10%' }}>✦</span>
        <span className="auth-emoji" style={{ top: '70%', right: '15%' }}>⋆</span>
        <span className="auth-emoji" style={{ top: '10%', left: '30%' }}>☾</span>
      </div>

      <form className="auth-card" onSubmit={handleSubmit}>
        <div className="auth-red-tab"></div>
        <div className="auth-label">01 / CREATE ACCOUNT</div>
        <h2 className="auth-title">Become a <span>Decoded</span></h2>
        
        <div className="auth-fields">
          <input className="auth-input" type="text" value={name} onChange={(e) => setUsername(e.target.value)} placeholder="Username" />
